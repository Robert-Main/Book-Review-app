    ...
    public class Seed
    {
        ...
        public void SeedDataContext()
        {
            ...
            var reviews = new List<Review>
            {
                ...
                {
                    Title = "Amazing read!",
                    Content = "Loved the characters and storyline.",
                    ReviewDate = DateTime.Now.AddDays(-10),
                    ReviewerName = reviewers[0].FirstName + " " + reviewers[0].LastName,
                    Book = books[0]
                },
                new Review
                {
                    Title = "Informative and engaging",
                    Content = "A great historical journey.",
                    ReviewDate = DateTime.Now.AddDays(-5),
                    ReviewerName = reviewers[1].FirstName + " " + reviewers[1].LastName,
                    Book = books[1]
                }
            };
